...
if (!empty($userNameInstance) and ($userRoleInstance === 'Admin' or $userRoleInstance === 'Employee')) {
  ...
  $guitarAllSql = "SELECT transaction.Transaction_ID, 
                      CONCAT(user.First_Name, ' ', user.Last_Name) AS Customer_Detail, 
                      CONCAT(employee.First_Name, ' ', employee.Last_Name) AS Employee_Detail, 
                  ...
                  LEFT JOIN employee ON transaction.Employee_ID = employee.Employee_ID;";
...
<head>
  ...
  <title>VLV | Transaction View Table</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">Transaction Table</h1>
            <!-- <button type="button" class="btn brown-button mt-2 <?php echo $dashboardLimiter; ?>">
            ...
            <div class="modal-dialog modal-lg" style="color: var(--clr-dark);">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5 section-header" id="staticBackdropLabel">Transaction Details</h1>
                  ...
                  <div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Tansaction ID:</label>
                        <input class="w-100 px-1" type="text" data-transaction-id disabled>
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Customer Name:</label>
                        <input class="w-100 px-1" type="text" data-customer-detail disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Employee Details:</label>
                        <input class="w-100 px-1" type="text" data-employee-id disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Date:</label>
                        <input class="w-100 px-1" type="text" data-date disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Payment:</label>
                        <input class="w-100 px-1" type="text" data-payment disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Total Amount:</label>
                        <input class="w-100 px-1" type="text" data-total-amount disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Paid:</label>
                        <input class="w-100 px-1" type="text" data-paid disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Change:</label>
                        <input class="w-100 px-1" type="text" data-change disabled />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12 white-bg p-0">
              ...
              <div class="responsive-table py-3 px-1" style="color: var(--clr-dark);">
                <table id="transactionTable" class="table table-striped dataTable-Universal">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <th scope="col" transaction-id-col><?php echo $guitarDataBase['Transaction_ID']; ?></th>
                        <td customer-detail-col><?php echo $guitarDataBase['Customer_Detail'] ?? 'N/A'; ?></td>
                        <td employee-id-col><?php echo $guitarDataBase['Employee_Detail']  ?? 'N/A'; ?></td>
                        <td transaction-date-col><?php echo date('F j, Y g:i A', strtotime($guitarDataBase['Transaction_Date'])); ?></td>
                        <td payment-method-col><?php echo $guitarDataBase['Payment_Method']; ?></td>
                        <td amount-due-col>₱<?php echo number_format($guitarDataBase['Amount_Due'], 2); ?></td>
                        <td amount-paid-col>₱<?php echo number_format($guitarDataBase['Amount_Paid'], 2); ?></td>
                        <td change-col>₱<?php echo number_format($guitarDataBase['Sukli'], 2); ?></td>
                        <?php if ($dashboardLimiter !== 'd-none') : ?>
