...
<head>
  ...
  <title>VLV | Customer View Table</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">Customer Table</h1>
                  ...
                  <div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        ...
                        <input class="w-100 px-1" type="text" data-customer-id disabled>
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">First Name:</label>
                        <input class="w-100 px-1" type="text" data-fname disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Last Name:</label>
                        <input class="w-100 px-1" type="text" data-lname disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Email:</label>
                        <input class="w-100 px-1" type="text" data-email disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Username:</label>
                        <input class="w-100 px-1" type="text" data-username disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Contact Number:</label>
                        <input class="w-100 px-1" type="text" data-contact-number disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Address:</label>
                        <input class="w-100 px-1" type="text" data-address disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Purchase Status:</label>
                        <input class="w-100 px-1" type="text" data-purchase-status disabled />
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12 white-bg p-0">
              ...
              <div class="responsive-table py-3 px-1" style="color: var(--clr-dark);">
                <table id="customerTable" class="table table-striped dataTable-Universal">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <th scope="col" customer-id-col><?php echo $guitarDataBase['User_ID']; ?></th>
                        <td customer-fname-col><?php echo $guitarDataBase['First_Name']; ?></td>
                        <td customer-lname-col><?php echo $guitarDataBase['Last_Name']; ?></td>
                        <td customer-email-col><?php echo $guitarDataBase['Email']; ?></td>
                        <td customer-username-col><?php echo $guitarDataBase['Username']; ?></td>
                        <td customer-cnumber-col><?php echo $guitarDataBase['Contact_Number']; ?></td>
                        <td customer-address-col><?php echo $guitarDataBase['Address']; ?></td>
                        <td customer-purchase-status-col><?php echo $guitarDataBase['Purchase_Status']; ?></td>
  ...
  <script src="../js/customerTableHandler.js"></script>
