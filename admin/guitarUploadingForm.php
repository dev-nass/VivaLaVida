...
<head>
  ...
  <title>VLV | Guitar Uploading</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">Guitar Uploading Form</h1>
          </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-8 col-lg-6 white-bg p-3">
              ...
              <form id="guitarUploadingForm" enctype="multipart/form-data">
                <!-- Brand -->
                <div class="d-flex mb-3 ">
                  <div class="col-6 ps-0">
                    <label for="guitarBrandInput" class="form-label darkViva-text">Brand</label>
                    <input name="guitarBrandInput" type="text" class="form-control input-search">
                  </div>
                  <!-- Model -->
                  <div class="col-6 pe-0">
                    <label for="guitarModelInput" class="form-label darkViva-text">Model</label>
                    <input name="guitarModelInput" type="text" class="form-control input-search">
                  </div>
                </div>
                <!-- Type: No extra div for d-flex -->
                <div class="mb-3">
                  <label for="guitarTypeInput" class="form-label darkViva-text">Type</label>
                  <input name="guitarTypeInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^a-zA-Z]/g, '');">
                </div>

                <div class="d-flex mb-3">
                  <!-- Fretboard Material -->
                  <div class="col-6 ps-0">
                    <label for="fretboardMaterialInput" class="form-label darkViva-text">Fretboard Material</label>
                    <input name="fretboardMaterialInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
                  </div>
                  <!-- Neck Material -->
                  <div class="col-6 pe-0">
                    <label for="neckMaterialInput" class="form-label darkViva-text">Neck Material</label>
                    <input name="neckMaterialInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
                  </div>
                </div>
                ...
                <div class="d-flex mb-3">
                  <!-- Body Material -->
                  <div class="col-6 ps-0">
                    <label for="bodyMaterialInput" class="form-label darkViva-text">Body Material</label>
                    <input name="bodyMaterialInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
                  </div>
                  <!-- Body Shape -->
                  <div class="col-6 pe-0">
                    <label for="bodyShapeInput" class="form-label darkViva-text">Body Shape</label>
                    <input name="bodyShapeInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');">
                  </div>
                </div>
                ...
                <div class="d-flex mb-3">
                  <!-- Number of Strings -->
                  <div class="col-6 ps-0">
                    <label for="numberOfStringsInput" class="form-label darkViva-text">Number of Strings</label>
                    <input name="numberOfStringsInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                  </div>
                  <!-- Number of Frets -->
                  <div class="col-6 pe-0">
                    <label for="numberOfFretsInput" class="form-label darkViva-text">Number of Frets</label>
                    <input name="numberOfFretsInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                  </div>
                </div>
                ...
                <!-- Price -->
                <div class="mb-3">
                  <label for="guitarPriceInput" class="form-label darkViva-text">Price</label>
                  <input name="guitarPriceInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                </div>
                <!-- Stocks -->
                <div class="mb-3">
                  <label for="guitarStocksInput" class="form-label darkViva-text">Stocks</label>
                  <input name="guitarStocksInput" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                </div>
                <!-- Guitar Picture -->
                <div class="mb-3">
                  <label for="guiarImageInput" class="form-label darkViva-text">Upload Image</label>
                  <input name="guitarImageInput" type="file" class="form-control input-search" accept="image/png, image/jpeg">
                </div>
                <!-- Guitar Description -->
                <div class="mb-3">
                  <label for="guitarDescriptionInput" class="form-label darkViva-text">Description</label>
                  <textarea name="guitarDescriptionInput" class="form-control input-search" aria-label="With textarea" maxlength="255"></textarea>
                </div>
  ...
  <script src="../js/guitarFormValidator.js"></script>
</body>
