...
if (!empty($userNameInstance) and ($userRoleInstance === 'Admin' or $userRoleInstance === 'Employee')) {
  ...
  $guitarAllSql = "SELECT urder.Order_ID, urder.Transaction_ID, CONCAT(guitar.Brand, ' ' , guitar.Model) as Guitar_Detail , guitar.Guitar_Picture, urder.Quantity, urder.Total_Price
                  FROM urder
...
<head>
  ...
  <title>VLV | Order View Table</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">Order Table</h1>
          </div>
            ...
            <div class="modal-dialog modal-lg" style="color: var(--clr-dark);">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5 section-header" id="staticBackdropLabel">Order's Details</h1>
                  ...
                  <div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Order ID:</label>
                        <input class="w-100 px-1" type="text" data-order-id disabled>
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Transaction ID:</label>
                        <input class="w-100 px-1" type="text" data-transaction-id disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Guitar Details:</label>
                        <input class="w-100 px-1" type="text" data-guitar disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Quantity:</label>
                        <input class="w-100 px-1" type="text" data-quantity disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Total Price:</label>
                        <input class="w-100 px-1" type="text" data-total-price disabled />
                      </div>
                    </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12 white-bg p-0">
              ...
              <div class="responsive-table py-3 px-1" style="color: var(--clr-dark);">
                <table id="orderTable" class="table table-striped dataTable-Universal">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <th scope="col" order-id-col><?php echo $guitarDataBase['Order_ID']; ?></th>
                        <td order-transaction-id-col><?php echo $guitarDataBase['Transaction_ID']; ?></td>
                        <td order-guitar-col><?php echo $guitarDataBase['Guitar_Detail']; ?></td>
                        <td order-guitar-picture-col><img src="<?php echo $guitarDataBase['Guitar_Picture']; ?>" alt="guitar-img" height="100" width="100" /></td>
                        <td order-quantity-col><?php echo $guitarDataBase['Quantity']; ?></td>
                        <td order-total-price-col>₱<?php echo number_format($guitarDataBase['Total_Price'], 2); ?></td>
                        <?php if ($dashboardLimiter !== 'd-none') : ?>
  ...
  <script src="../js/orderTableHandler.js"></script>
