...
<head>
  ...
  <title>VLV | User View Table</title>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav darkViva-bg sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="../admin/orderingGuitar.php">
      ...
      <li class="nav-item <?php echo $dashboardLimiter ?>">
        <a class="nav-link" href="../admin/employeeAdding.php">
      ...
      <div id="content">
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">User Table</h1>
            <button type="button" class="btn brown-button mt-2 <?php echo $dashboardLimiter; ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            ...
            <div class="modal-dialog modal-lg" style="color: var(--clr-dark);">
              <div class="modal-content">
                <div class="modal-header">
                  <h1 class="modal-title fs-5 section-header" id="staticBackdropLabel">User's Information</h1>
                ...
                <div class="modal-body">
                  <div>
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Age:</label>
                        <input class="w-100 px-1" type="text" data-age required oninput="this.value = this.value.replace(/[^0-9]/g, '');" />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                      ...
                      <div class="col-12 col-lg-6">
                        ...
                        <input class="w-100 px-1" type="text" data-address required />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                      ...
                      <div class="col-12 col-lg-6">
                        ...
                        <input class="w-100 px-1" type="text" data-email required />
                      </div>
                    </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12 white-bg p-0">
              ...
              <div class="responsive-table py-3 px-1" style="color: var(--clr-dark);">
                <table id="userTable" class="table table-striped dataTable-Universal">
                  <thead>
                    <tr>
                      <th scope="col">ID</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        <th scope="col" user-id-col><?php echo $guitarDataBase['User_ID']; ?></th>
                        <td user-fname-col><?php echo $guitarDataBase['First_Name']; ?></td>
                        <td user-lname-col><?php echo $guitarDataBase['Last_Name']; ?></td>
                        <td user-age-col><?php echo $guitarDataBase['Age']; ?></td>
                        <td user-username-col><?php echo $guitarDataBase['Username']; ?></td>
                        <td user-email-col><?php echo $guitarDataBase['Email']; ?></td>
                        <td user-cnumber-col><?php echo $guitarDataBase['Contact_Number']; ?></td>
                        <td user-address-col><?php echo $guitarDataBase['Address']; ?></td>
                        <?php if ($dashboardLimiter !== 'd-none') : ?>
                          <td><button id="select-btn" class="btn brown-button">Select</button></td>
                        <?php endif; ?>
                      </tr>
                    <?php
                    }
  ...
  <script src="../js/userTableHandler.js"></script>
