...
if (!empty($userNameInstance) and ($userRoleInstance === 'Admin' or $userRoleInstance === 'Employee')) {
  ...
  $guitarAllSql = "SELECT GuitarID, Type, Brand, Model, Guitar_Picture, Price, Stocks FROM guitar";
...
<head>
  ...
  <title>VLV | Guitar Prices & Stocks</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">Prices & Stocks</h1>
                  ...
                  <div>
                    <div class="row mb-2">
                      ...
                      <div class="col-12 col-lg-6">
                        ...
                        <input class="w-100 px-1" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');" data-guitar-type disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Brand:</label>
                        <input class="w-100 px-1" type="text" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');" data-guitar-brand disabled />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Model:</label>
                        <input class="w-100 px-1" type="text" oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '');" data-guitar-model disabled />
                      </div>
                    </div>
                    <div class="row mb-2">
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Price:</label>
                        <input class="w-100 px-1" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '');" data-guitar-price required />
                      </div>
                      <div class="col-12 col-lg-6">
                        <label for="" class="mb-0">Stocks:</label>
                        <input class="w-100 px-1" type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '');" data-guitar-stocks required />
                      </div>
                    </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td guitar-price-col><?php echo $guitarDataBase['Price']; ?></td>
                        <td guitar-stocks-col><?php echo $guitarDataBase['Stocks']; ?></td>
  ...
  <script src="../js/guitarTableHandlerPrice&Stocks.js"></script>
