...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav darkViva-bg sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link <?php echo $dashboardLimiter ?>" href="../admin/userViewTable.php">
      ...
      <div id="content">
              ...
              <div class="profile">
                <div class="dropdown-center">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="normal-font dropdown-item" href="dropdown-item">Hello, <?php echo $userNameInstance; ?> </a></li>
                    <li>
        ...
        <div class="container-fluid whiteViva-bg">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 darkViva-text section-header" style="text-transform: uppercase;">Add Customer</h1>
          </div>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-sm-8 col-lg-6 white-bg p-3">
              ...
              <form id="customerAddingForm" enctype="multipart/form-data">

                <div class="d-flex mb-3">
                  <!-- First Name -->
                  <div class="col-6 ps-0">
                    <label for="customer_fname" class="form-label darkViva-text">First Name</label>
                    <input name="customer_fname" type="text" class="form-control input-search" >
                  </div>
                  <!-- Last Name -->
                  <div class="col-6 pe-0">
                    <label for="customer_lname" class="form-label darkViva-text">Last Name</label>
                    <input name="customer_lname" type="text" class="form-control input-search" >
                  </div>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="col-12 ps-0 pe-0">
                    <label for="customer_username" class="form-label darkViva-text">Username</label>
                    <input name="customer_username" type="text" class="form-control input-search">
                  </div>
                </div>
                ...
                <div class="d-flex mb-3">
                  <!-- Email -->
                  <div class="col-6 ps-0">
                    <label for="customer_email" class="form-label darkViva-text">Email</label>
                    <input name="customer_email" type="email" class="form-control input-search" placeholder="juan@gmail.com">
                  </div>
                  <!-- Contact Number -->
                  <div class="col-6 pe-0">
                    <label for="customer_contact_number" class="form-label darkViva-text">Contact Number</label>
                    <input name="customer_contact_number" type="text" class="form-control input-search" oninput="this.value = this.value.replace(/[^0-9+\-() ]/g, '');" maxlength="11" placeholder="09XXXXXXXXX">
                  </div>
                </div>
                ...
                <div class="d-flex mb-3">
                  <!-- Password -->
                  <div class="col-6 ps-0">
                    <label for="customer_password" class="form-label darkViva-text">Password</label>
                    <input name="customer_password" type="password" class="customer_password_input form-control input-search" placeholder="Enter at least 8 letters" />
                  </div>
                  <!-- Re-type Password -->
                  <div class="col-6 pe-0">
                    <label for="customer_repassword" class="form-label darkViva-text">Re-type Password</label>
                    <input name="customer_repassword" type="password" class="customer_repassword_input form-control input-search" />
                  </div>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn brown-button">Create<span><i class="fas fa-fw fa-arrow-up-from-bracket"></i></span></button>
                </div>
              </form>
            </div>
  ...
  <!-- Custom JS -->
  <script src="../js/customerFormValidator.js"></script>
</body>
